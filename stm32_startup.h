...
#define SRAM_SIZE           (128 *1024)             //128KB = 112KB + 16KB
...
//user application function will overwrite the weak function
...
void TIIM8_UP_TIM13_Handler(void) __attribute__((weak, alias("Default_Handler")));
void TIM_TRG_COM_TIM14_Handler(void) __attribute__((weak, alias("Default_Handler")));
...
void UASRT6_Handler(void) __attribute__((weak, alias("Default_Handler")));
...
//This is the array for vector table, the array has to be store in .vector section
//without compiler section attribute, the array will be placed in .data
//interrupt and event vector table
uint32_t vector_table[] __attribute__((section(".isr_vector"), aligned(4))) = {
    STACK_START,
    ...
    (uint32_t) &TIIM8_UP_TIM13_Handler,
    (uint32_t) &TIM_TRG_COM_TIM14_Handler,
